 ...
 */
async function startLegacyDiscoveryProcess() {
 ...
 * @returns {string} discovery process GUID
 */
async function startDiscoveryProcess(parameters = {}) {
  const name = parameters.resourceUuid
    ? '--name=resourceEntitiesDiscovery'
    : '--name=undiscoveredResourcesEntitiesDiscovery'
