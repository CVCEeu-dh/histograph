...
apiRouter.route('/resource/elastic')
  .get(ctrl.resource.getElastic)
...
apiRouter.route('/suggest/:entity(entity|person|location|organization|theme|place)')
...
apiRouter.route('/suggest/:entity(person|location|organization|theme|place)/graph')
