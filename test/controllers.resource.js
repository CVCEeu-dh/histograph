...
describe('controller:resource (related resources)', function() {
  ...
  it('should get the facet related to a specific resource for a specific filtered query', function (done) {
    session
      .get('/api/resource/'+ __resourceA.id +'/related/resource/elastic?entity=person&limit=23&offset=3')
      .expect('Content-Type', /json/)
      .expect(200)
      .end(function (err, res) {
        if(err)
